const zhCN = {
  ...
  settings: {
    ...
    ai_chat: {
      title: "AI 问答工具",
      description: "配置文档摘要工具行为，并为整文总结单独指定更便宜的模型。",
      digest_mode: "文档摘要模式",
      digest_mode_desc:
        "控制 get_document_digest 如何生成整文或大范围页面摘要。",
      digest_mode_excerpt: "本地摘录",
      digest_mode_ai_summary: "AI 摘要",
      summary_model: "摘要模型",
      summary_model_placeholder: "选择模型",
      summary_model_desc:
        "仅在启用 AI 摘要模式时用于 get_document_digest。建议在这里选择成本更低的聊天模型。",
      no_models: "无可用模型",
      digest_chars_per_chunk: "每块输出字符数",
      digest_source_chars_per_chunk: "每块输入采样字符数",
      digest_sampling_desc:
        "输入采样字符数决定摘要前会抽取多少源文本。数值越大覆盖越好，但成本也会更高。",
    },
    done: "完成",
  },
  landing: {
