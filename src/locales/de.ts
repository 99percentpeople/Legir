const de = {
  ...
  properties: {
    ...
    bring_forward: "Eine Ebene nach vorn",
    ...
    end_arrow: "Endpfeil",
    arrow_style: "Pfeilstil",
    arrow_style_closed_arrow: "Geschlossener Pfeil",
    arrow_style_line_arrow: "Linienpfeil",
    arrow_style_hollow_arrow: "Hohler Pfeil",
    arrow_style_circle: "Kreis",
    arrow_style_square: "Quadrat",
    arrow_style_diamond: "Raute",
    arrow_style_slash: "Schrägstrich",
    reverse_direction: "Richtung umkehren",
    arrow_size: "Pfeilgröße",
    cloud_intensity: "Wolkenintensität",
    cloud_spacing: "Wolkenabstand",
    shape_type: "Formtyp",
  ...
  settings: {
    ...
    translation: {
      ...
      google_cloud_desc:
        "Geben Sie hier den Google Cloud Translation API-Schlüssel ein. Der Schlüssel wird nur aus den App-Einstellungen gelesen.",
