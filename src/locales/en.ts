const en = {
  ...
  toolbar: {
    ...
    stamp: "Stamp",
    stamp_properties: "Stamp Properties",
    shape: "Shape",
    ...
    shape_box_tools: "Box Shapes",
    shape_path_tools: "Path Shapes",
  ...
  settings: {
    ...
    translation: {
      ...
      ai_enabled: "Enable AI translation services",
      ai_enabled_desc:
        "Allow configured LLM providers to be used for translation. This does not affect the AI assistant.",
    },
    language: "Language",
    theme: "Theme",
    ...
    llm: {
      ...
      custom_models_desc:
        "Add a model by name, choose its capability profile, and it will appear in the model list.",
      custom_models_empty: "No custom models yet.",
      custom_model_name_placeholder: "Enter a model name",
      custom_model_capability: "Capability",
      custom_model_capability_text: "Text",
      custom_model_capability_image: "Image",
      custom_model_capability_tools: "Tools",
      custom_model_add: "Add",
  ...
  home: {
    ...
    desktop: {
      ...
      pdf_badge: "PDF",
      open: "Open",
      view_mode: "Recent files view",
      view_list: "List view",
      view_grid: "Grid view",
      file_actions: "File actions",
      list_column_name: "Name",
      list_column_time: "Time",
