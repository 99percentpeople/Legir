const fr = {
  ...
  translate: {
    ...
    no_available_services: "Aucun service disponible",
    model: "Modèle",
    target: "Langue cible",
  ...
  settings: {
    ...
    translation: {
      ...
      ai_enabled: "Activer les services de traduction IA",
      ai_enabled_desc:
        "Autorise les fournisseurs LLM configurés pour la traduction, sans affecter l’assistant IA.",
    },
    language: "Langue",
    theme: "Thème",
    ...
    ai_chat: {
      ...
      form_tools_enabled_desc:
        "Permet à l'assistant IA de créer de nouveaux champs de formulaire à partir des demandes conversationnelles. Laissez cette option désactivée si vous ne voulez qu'une assistance en lecture seule et le remplissage des champs.",
