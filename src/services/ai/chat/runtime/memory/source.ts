...
export const truncateAiChatContextMemorySource = (lines: string[]) => {
  const result: string[] = [];
  let totalChars = 0;
...
export const getContextMemorySourceLines = (
...
export const appendAdditionalCompressedMemoryText = (
  memoryText: string,
  messages: AiChatMessageRecord[],
) => {
...
export const messageContainsAiChatHeavyVisualTool = (
