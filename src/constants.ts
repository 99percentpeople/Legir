...
export const WORKSPACE_BASE_PAGE_GAP_PX = 24;
...
export const AI_CHAT_CONVERSATION_SUMMARY_MAX_SOURCE_CHARS = 18_000;
export const AI_CHAT_CONVERSATION_SUMMARY_MAX_CHARS = 2_400;
