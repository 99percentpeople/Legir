...
const AnnotationCard: React.FC<AnnotationCardProps> = ({
  ...
  }, [focusTextarea, isEditingMain, isSelected, scrollIntoView]);
...
export interface AnnotationsPanelViewProps {
...
export const AnnotationsPanelView: React.FC<AnnotationsPanelViewProps> = ({
  annotations,
  canEditAnnotations,
  restrictedTitle,
...
export default AnnotationsPanelView;
