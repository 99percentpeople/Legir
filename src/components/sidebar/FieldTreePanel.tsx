           ...
           return (
             <div key={page.pageIndex} className="mb-1">
               ...
               >
                 ...
                 <Badge variant="secondary" className="ml-auto px-1.5 py-0 h-5 min-w-5 justify-center">
                   ...
                   {visibleFields.length > 0 ? (
                     visibleFields.map(field => {
                       ...
                       return (
                         ...
                         >
                           <Icon size={12} className={cn("mr-2 shrink-0", selectedFieldId === field.id ? "text-primary" : "text-muted-foreground")} />
